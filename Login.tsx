  ...
  return (
    <View style={tw`flex-1 bg-white items-center justify-center`}>
      ...
      <View style={tw`w-4/5 max-w-sm p-6 bg-white border border-yellow-500 rounded-lg shadow-lg items-center`}>
        ...
        <Text style={tw `mt-3 text-center`} >Forgot password? <Text   onPress={() => navigation.navigate('Reset')}  style={tw `text-yellow-500 `} >Reset</Text></Text>
        <Text style={tw `mt-2 text-center font-semibold`} >OR</Text>
        
        <Text style={tw `mt-3 text-center`} >Don't have an account? <Text  onPress={() => navigation.navigate('Register')} style={tw `text-yellow-500 `} >Register</Text></Text>
